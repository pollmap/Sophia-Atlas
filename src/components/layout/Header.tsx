...
const navEntries: NavEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "철학 그래프", description: "철학자 영향 관계 그래프", href: "/philosophy/graph" },
      { label: "종교 분파", description: "종교별 분파 트리", href: "/religion/tree" },
      { label: "검색", description: "통합 검색", href: "/search" },
      { label: "소개", description: "프로젝트 소개", href: "/about" },
    ],
  },
];
